...
//      }
  ...
  Future setPdfAnnots(Iterable<PdfAnnotation> annots) {
    return db.setPdfAnnotations(annots); 
  }
  
  /// Sets the given annotation.
  Future setPdfAnnot(PdfAnnotation annot) {
    return db.setPdfAnnotation(annot); 
  }
    
  /// Deletes the given user.
  Future deletePdfAnnots() {   
    return db.deletePdfAnnotations(this.annotsCache.values);
  }
  
  /// Deletes the given user.
  Future deletePdfAnnot(PdfAnnotation annot) {   
  ...
  Map<String, PdfAnnotation> getPdfAnnots() {
    return annotsCache;
  }
  
  /// Returns the pdf annotation with given id.
  PdfAnnotation getPdfAnnot(String id) {
