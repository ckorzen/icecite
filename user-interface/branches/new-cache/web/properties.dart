...
const String DB_REMOTE = 'http://user:user@localhost:5984/';
...
String DB_ENTRIES_NAME(userId) => "$DB_ENTRIES_PREFIX-${userId}"; 
/// The replication url of feeds db for given user.
String DB_ENTRIES_URL() => DB_REMOTE + DB_ENTRIES_PREFIX;
