...
class PdfAnnotation extends Pouchable {
  /// Creates a new annot.
  PdfAnnotation() : super(PouchableType.PDF_ANNOTATION);
  
  /// Creates a pdf annotation from map.
  PdfAnnotation.fromData(Map map) : super.fromData(PouchableType.PDF_ANNOTATION, map);
  
  /// Creates a pdf annotation from json.
  PdfAnnotation.fromJson(String json) : super.fromJson(PouchableType.PDF_ANNOTATION, json);
