...
class UserElement extends IceciteElement {  
  ...
  static const String SHARE_REQUEST = "share-request";
  /// The name of "user-disinvited" event.
  static const String UNSHARE_REQUEST = "unshare-request";
  ...
  void handleDropped(MouseEvent event) {
    ...
    fireShareRequest(entryId, member.id);
  }
  ...
  void fireShareRequest(String entryId, String userId) {
    fire(SHARE_REQUEST, detail: {'userId': userId, 'entryId': entryId});
  }
  
  /// Fires a 'user-disinvited' event.
  void fireUnshareRequest() {
    fire(UNSHARE_REQUEST, detail: member);
  }
}