...
//  }
  ...
  // XXX: Added by CK.
  Token get _storedToken {
    JsObject localStorage = context['localStorage'];
    if (localStorage != null) {
      String value = localStorage.callMethod('getItem', [_storageKey]);
      if (value != null) {
  ...
  void set _storedToken(Token value) {
    ...
    if (localStorage != null) {
      if (value == null) {
        localStorage.callMethod("removeItem", [_storageKey]);
      } else {
        localStorage.callMethod("setItem", [_storageKey, value.toJson()]);
      }
    }
  }
