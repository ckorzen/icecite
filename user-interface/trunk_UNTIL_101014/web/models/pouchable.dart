...
class Pouchable extends Observable {
  DateFormat dateFormat = new DateFormat.yMMMMd("en_US").add_Hm();
  @observable Map map;
  ...
  Pouchable.fromMap(Map map) {
    this.map = {};
    map.forEach((key, value) => this[key] = stringify(value));
  }
...
//  String toJson() => JSON.encode(map);
  ...
  /// Compares this library entry to given other object.
  bool operator==(other) {
